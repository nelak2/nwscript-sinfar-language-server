...
int EVENT_BLOCKED=1012;
int EVENT_DEATH=1013;
int EVENT_SPAWN=1021;
...
int SetCampaignFloat(string sCampaignName, string sVarName, float flFloat, object oPlayer=OBJECT_INVALID);
int SetCampaignInt(string sCampaignName, string sVarName, int nInt, object oPlayer=OBJECT_INVALID);
int SetCampaignVector(string sCampaignName, string sVarName, vector vVector, object oPlayer=OBJECT_INVALID);
int SetCampaignLocation(string sCampaignName, string sVarName, location locLocation, object oPlayer=OBJECT_INVALID);
int SetCampaignString(string sCampaignName, string sVarName, string sString, object oPlayer=OBJECT_INVALID);
...
void HttpRequest(string sUrl, string sCallbackScript, array aCallbackParams, string sMethod="GET", string sBody="");
void LogDebug(string sLogMessasge, string sPrefix="");
void LogWarning(string sLogMessasge, string sPrefix="");
void LogError(string sLogMessasge, string sPrefix="");
int HomeIdFromObject(object oObject);
int IsPlayerScriptObject(object oObject);
int HouseScriptHomeId();
void RemovePlayerHouseEffects(object oObject);
array CORE_GetPlayerDefaultCDKeys(string sPlayerName);
string GetResRefPrefix(string sResRef);
string GetResRefErfPrefix(string sResRef);
int GetResRefErfId(string sResRef);
int GetResRefErfServers(string sResRef);
void PrintToStdErr(string sPrint);
void PrintToStdOut(string sPrint);
int IsOnSinfarWorld();
void PrepareToDestroy(object oObject);
int GetScriptExecuteStackPointer();
string GetScriptNameByExecuteIndex(int nExecuteIndex);
int GetActionGroupId(object oObject, int nAction);
int GetActionParamCount(object oObject, int nAction);
int GetActionParamType(object oObject, int nAction, int nParam);
int GetActionParamInt(object oObject, int nAction, int nParam);
float GetActionParamFloat(object oObject, int nAction, int nParam);
object GetActionParamObject(object oObject, int nAction, int nParam);
string GetActionParamString(object oObject, int nAction, int nParam);
location GetActionParamLocation(object oObject, int nAction, int nParam);
int GetActionInterruptable(object oObject, int nAction);
void AddAction(object oObject, int nActionType, array aParams, int nActionGroupId=-1);
void AddActionToFront(object oObject, int nActionType, array aParams, int nActionGroupId=-1);
void AddActionAfterFront(object oObject, int nActionType, array aParams, int nActionGroupId=-1);
void ActionDoCommandToBack(action aActionToDo, int nActionGroupId=-1);
void ActionDoCommandToFront(action aActionToDo, int nActionGroupId=-1);
void ActionDoCommandAfterFront(action aActionToDo, int nActionGroupId=-1);
int GetCurrentActionType(object oObject);
int GetCurrentActionGroupId(object oObject);
int GetCurrentActionParamCount(object oObject);
int GetCurrentActionParamType(object oObject, int nParam);
