...
export const contrastActiveBorder = create<string>("contrast-active-border", "--vscode-contrastActiveBorder").withDefault(
  "#f38518",
);
...
export const buttonIconHoverBackground = create<string>("button-icon-hover-background", "--fake-vscode-token").withDefault(
  "rgba(90, 93, 94, 0.31)",
);
export const buttonIconPadding = create<string>("button-icon-padding").withDefault("3px");
export const buttonPrimaryBackground = create<string>("button-primary-background", "--vscode-button-background").withDefault(
  "#0e639c",
);
export const buttonPrimaryForeground = create<string>("button-primary-foreground", "--vscode-button-foreground").withDefault(
  "#ffffff",
);
...
export const listHoverBackground = create<string>("list-hover-background", "--vscode-list-hoverBackground").withDefault(
  "#2a2d2e",
);
...
export const dividerBackground = create<string>("divider-background", "--vscode-settings-dropdownListBorder").withDefault(
  "#454545",
);
...
export const linkActiveForeground = create<string>("link-active-foreground", "--vscode-textLink-activeForeground").withDefault(
  "#3794ff",
);
...
export const panelTabActiveBorder = create<string>("panel-tab-active-border", "--vscode-panelTitle-activeBorder").withDefault(
  "#e7e7e7",
);
...
export const panelTabForeground = create<string>("panel-tab-foreground", "--vscode-panelTitle-inactiveForeground").withDefault(
  "#e7e7e799",
);
